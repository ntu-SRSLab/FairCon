...
contract BetterAuction {
   ...
   function _Main_(address payable msg_sender1, uint p1, uint msg_value1, uint msg_gas1, uint block_timestamp1, 
		   ...
		   address payable msg_sender4, uint p4, uint msg_value4, uint msg_gas4, uint block_timestamp4,
   	       	   address payable msg_sender5, uint p5, uint msg_value5, uint msg_gas5, uint block_timestamp5
		  ) public {
	   ...
	   require(!(msg_sender5==msg_sender4));
           ...
           require(pendingReturns[msg_sender5] == 0);
           ...
           // each role claims the 'bid' action.
            ...
            bid(msg_sender5,msg_value5);

              // assert(msg_sender3 == highestBidder);
            assert(msg_sender1 == highestBidder || msg_sender2 == highestBidder ||  msg_sender3 == highestBidder||  msg_sender4 == highestBidder||  msg_sender5 == highestBidder );
	    ...
	    uint secondhighest_price = 0;
            ...
            if(highest_price<msg_value5){
		    secondhighest_price = highest_price;
		    highest_price = msg_value5;
	    }
	    else if (secondhighest_price < msg_value5){
		    secondhighest_price = msg_value5;
	    }
            ...
            if ( msg_sender5 == highestBidder ){
                        ...
                        winners_count ++;
			winner_value = msg_value5;
                        utilities[msg_sender5] = p5 -highestBid ;
                        benefits[msg_sender5]  = p5;
                        payments[msg_sender5]  = highestBid;
            }
	    ...
	    uint payment = payments[msg_sender1]+payments[msg_sender2]+payments[msg_sender3]+payments[msg_sender4]+payments[msg_sender5];
            sse_optimal_violate_check(payment,highestBidder,msg_sender1);
            sse_optimal_violate_check(payment,highestBidder,msg_sender2);
            sse_optimal_violate_check(payment,highestBidder,msg_sender3);
            sse_optimal_violate_check(payment,highestBidder,msg_sender4);
            sse_optimal_violate_check(payment,highestBidder,msg_sender5);
