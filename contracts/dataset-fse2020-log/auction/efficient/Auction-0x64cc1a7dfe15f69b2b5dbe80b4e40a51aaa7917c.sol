   ...
   function _Main_(address payable msg_sender1, uint p1, uint msg_value1, uint msg_gas1, uint block_timestamp1, address payable msg_sender2, uint p2, uint msg_value2, uint msg_gas2, uint block_timestamp2,address payable msg_sender3, uint p3, uint msg_value3, uint msg_gas3, uint block_timestamp3) public {
        ...
        //    require(msg_value3==p3);
           ...
           // each role claims the 'bid' action.
            ...
            sse_efficient_expectation_register(leader, msg_sender1, p1);
            sse_efficient_expectation_register(leader, msg_sender2, p2);
            sse_efficient_expectation_register(leader, msg_sender3, p3);
            sse_efficient_violate_check(benefits[msg_sender1]+benefits[msg_sender2]+benefits[msg_sender3],leader,msg_sender1);
            sse_efficient_violate_check(benefits[msg_sender1]+benefits[msg_sender2]+benefits[msg_sender3],leader,msg_sender2);
            sse_efficient_violate_check(benefits[msg_sender1]+benefits[msg_sender2]+benefits[msg_sender3],leader,msg_sender3);
   }
}