     ...
     address payable msg_sender3, uint p3, uint msg_value3, uint msg_price3, uint block_timestamp3) public {
        ...
        //    require(msg_price3==p3);
           ...
           // each role claims the 'bid' action.
            ...
            sse_efficient_expectation_register(winnerAddr, msg_sender1, p1);
            sse_efficient_expectation_register(winnerAddr, msg_sender2, p2);
            sse_efficient_expectation_register(winnerAddr, msg_sender3, p3);
            sse_efficient_violate_check(benefits[msg_sender1]+benefits[msg_sender2]+benefits[msg_sender3],winnerAddr,msg_sender1);
            sse_efficient_violate_check(benefits[msg_sender1]+benefits[msg_sender2]+benefits[msg_sender3],winnerAddr,msg_sender2);
            sse_efficient_violate_check(benefits[msg_sender1]+benefits[msg_sender2]+benefits[msg_sender3],winnerAddr,msg_sender3);
   }
}
