...
local variables: 
	varName: winners_count@1235, value: winners_count@1235_0_, sort: Int
...
----------------State Variable-----------------------
|name                |value               |
|payments            |(store ((as const (Array String Int)) 0) "!3!" 120000000000)|
|utilities           |((as const (Array String Int)) 0)|
|fundsByBidder       |(store ((as const (Array String Int)) 0) "!1!" 120000000000)|
|blockerPay          |false               |
|highestBidder       |"!3!"               |
|oldHighestBindingBid|0                   |
|oldPotato           |120000000000        |
|benefits            |(store ((as const (Array String Int)) 0) "!3!" 120000000000)|
...
hint
msg_value1@966_0_: 120000000001
...
*         report                    *
*************************************
* model construction time: 2.407s
*  property checking time: 0.072s
*              total time: 2.479s
