...
local variables: 
	varName: winners_count@879, value: winners_count@879_0_, sort: Int
...
----------------State Variable-----------------------
|name                |value               |
|payments            |(store ((as const (Array String Int)) 0) "!0!" 100000000002)|
...
|pendingReturns      |((as const (Array String Int)) 0)|
----------------Local Variable-----------------------
|winners_count       |1                   |
...
hint
msg_value1@616_0_: 100000000002
msg_value1@616_0_#2: 100000000001
a's utility::0
new a's utility:1
-------------------------------------------------------------------------
...
*         report                    *
*************************************
* model construction time: 1.573s
