...
local variables: 
	varName: winners_count@559, value: winners_count@559_0_, sort: Int
...
----------------State Variable-----------------------
|name                |value               |
|utilities           |(store ((as const (Array String Int)) 0) "!3!" (- 1))|
|leader              |"!3!"               |
|bids                |2                   |
|prize               |10000000000000      |
|payments            |(store ((as const (Array String Int)) 0) "!3!" 200000000001)|
|benefits            |(store ((as const (Array String Int)) 0) "!3!" 200000000000)|
|deadline            |20                  |
|bidDivisor          |100                 |
|duration            |20                  |
----------------Local Variable-----------------------
...
hint
msg_value1@299_0_: 200000000001
