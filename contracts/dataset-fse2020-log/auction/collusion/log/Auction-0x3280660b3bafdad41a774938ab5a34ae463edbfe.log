...
local variables: 
	...
	varName: winners_count@891, value: winners_count@891_0_, sort: Int
...
----------------State Variable-----------------------
|name                |value               |
|payments            |(let ((a!1 (store (store (store ((as const (Array String Int)) 8) "!0!" 0)
                         "!3!"
                         0)
                  "!2!"
                  0)))
  (store a!1 "!0!" 100000000016))|
|benefits            |(let ((a!1 (store (store (store ((as const (Array String Int)) 6) "!0!" 0)
                         "!3!"
                         0)
                  "!2!"
                  0)))
...
|utilities           |(let ((a!1 (store (store (store ((as const (Array String Int)) 7) "!0!" 0)
                         "!3!"
                         0)
                  "!2!"
                  0)))
...
|bids                |(let ((a!1 (store (store (store ((as const (Array String Int)) 1) "!0!" 0)
                  ...
                  "!2!"
                  0)))
  (store (store (store a!1 "!0!" 100000000016) "!2!" 125000000018)
         "!3!"
         125000000019))|
----------------Local Variable-----------------------
|msg_value3          |125000000019        |
|p3                  |125000000019        |
|msg_sender3         |"!3!"               |
|block_timestamp2    |1082                |
|p2                  |125000000018        |
|block_timestamp1    |991                 |
|p1                  |100000000016        |
|msg_value           |125000000019        |
|msg_sender2         |"!2!"               |
|msg_sender          |"!3!"               |
|msg_value1          |100000000016        |
|msg_value2          |125000000018        |
|block_timestamp     |0                   |
|block_timestamp3    |0                   |
|winners_count       |1                   |
|msg_sender1         |"!0!"               |
...
hint
msg_value1@599_0_:100000000016
msg_value2@609_0_:125000000018
msg_value1@599_0_#2:125000000016
msg_value2@609_0_#2:156250000020
v1&v2's utility:0
new v1&v2's colluded utility:2
-------------------------------------------------------------------------
...
*         report                    *
*************************************
* model construction time: 7.862s
*  property checking time: 0.113s
*              total time: 7.975s
