...
local variables: 
	...
	varName: winners_count@529, value: winners_count@529_0_, sort: Int
...
|bids                |(let ((a!1 (store (store (store ((as const (Array String Int)) 1) "!3!" 0)
                  ...
                  "!2!"
                  0)))
  (store (store (store a!1 "!0!" 183000000024) "!2!" 228750000025)
         "!3!"
         100000000025))|
...
|msg_value2          |228750000025        |
|msg_value           |100000000025        |
|winners_count       |1                   |
|msg_value3          |100000000025        |
|p3                  |100000000025        |
|msg_sender1         |"!0!"               |
|p1                  |183000000024        |
|msg_value1          |183000000024        |
|p2                  |228750000025        |
-------------------------------------------
...
hint
msg_value1@215_0_:183000000024
msg_value2@225_0_:228750000025
msg_value1@215_0_#2:183000000016
msg_value2@225_0_#2:228750000020
v1&v2's utility:0
new v1&v2's colluded utility:5
-------------------------------------------------------------------------
...
*         report                    *
*************************************
* model construction time: 7.471s
