...
local variables: 
	varName: winners_count@525, value: winners_count@525_0_, sort: Int
...
|userEtherOf         |(let ((a!1 (store (store (store ((as const (Array String Int)) 2) "!2!" 0)
                  ...
                  "!1!"
                  0)))
(let ((a!2 (store (store (store (store a!1 "!3!" 0) "!0!" 100000000001)
                         "!2!"
                         100000001238)
                  "!3!"
                  0)))
...
|p3                  |100000000001        |
|msg_price2          |899999991144        |
|msg_value2          |100000001238        |
|msg_sender          |"!3!"               |
|_price              |100000000001        |
|block_timestamp     |0                   |
|msg_sender3         |"!3!"               |
|_result             |true                |
|msg_price1          |100000000002        |
...
hint
msg_price1@220_0_:100000000002
msg_price2@230_0_:899999991144
msg_price1@220_0_#2:100000000001
msg_price2@230_0_#2:100000000002
v1&v2's utility:0
new v1&v2's colluded utility:799999991142
-------------------------------------------------------------------------
...
*         report                    *
*************************************
* model construction time: 6.165s
