...
local variables: 
	varName: winners_count@796, value: winners_count@796_0_, sort: Int
...
----------------State Variable-----------------------
|name                |value               |
|payments            |(store (store (store ((as const (Array String Int)) 7) "!3!" 0) "!2!" 0)
       "!0!"
       399999983272)|
|startingPrice       |0                   |
|currentBid          |399999983272        |
|totalBids           |1                   |
|auctionEnd          |0                   |
|hotPotatoPrize      |19999999163         |
|currentMinBid       |599999974908        |
|balanceOf           |(store (store (store ((as const (Array String Int)) 4) "!3!" 0) "!2!" 0)
       "!0!"
       419999982435)|
|highBidder          |"!0!"               |
|utilities           |(store (store (store ((as const (Array String Int)) 5) "!3!" 0) "!2!" 0)
       "!0!"
       0)|
|benefits            |(store (store (store ((as const (Array String Int)) 6) "!3!" 0) "!2!" 0)
       "!0!"
       399999983272)|
----------------Local Variable-----------------------
|winners_count       |1                   |
|p3                  |150000000006        |
|msg_sender3         |"!3!"               |
|msg_value2          |599999974905        |
|p2                  |599999974905        |
|msg_sender2         |"!2!"               |
|msg_value1          |399999983272        |
|p1                  |399999983272        |
|block_timestamp1    |(- 1)               |
|block_timestamp     |(- 1)               |
|msg_value           |150000000006        |
|block_timestamp2    |(- 1)               |
|msg_value3          |150000000006        |
|block_timestamp3    |(- 1)               |
|msg_sender          |"!3!"               |
|msg_sender1         |"!0!"               |
-------------------------------------------
...
hint
msg_value1@518_0_:399999983272
msg_value2@528_0_:599999974905
msg_value1@518_0_#2:100000000004
msg_value2@528_0_#2:150000000006
v1&v2's utility:0
new v1&v2's colluded utility:449999974899
-------------------------------------------------------------------------
...
*         report                    *
*************************************
* model construction time: 5.452s
*  property checking time: 0.09s
*              total time: 5.542s
