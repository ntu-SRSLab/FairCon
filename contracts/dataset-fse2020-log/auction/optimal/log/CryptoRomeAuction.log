...
local variables: 
	...
	varName: winners_count@491, value: winners_count@491_0_, sort: Int
...
----------------State Variable-----------------------
|name                |value               |
|benefits            |((as const (Array String Int)) 0)|
|extensionTime       |2                   |
|utilities           |((as const (Array String Int)) 0)|
|auctionStart        |0                   |
|payments            |(store (store (store ((as const (Array String Int)) 0) "!0!" 100000000001)
              "!2!"
              0)
       "!3!"
       0)|
...
*         report                    *
*************************************
* model construction time: 7.996s
