...
----------------State Variable-----------------------
|name                |value               |
|payments            |(let ((a!1 (store (store (store ((as const (Array String Int)) 3) "!3!" 0)
                         "!2!"
                         0)
                  "!0!"
                  0)))
  (store a!1 "!3!" 0))|
|benefits            |(let ((a!1 (store (store (store ((as const (Array String Int)) 2) "!3!" 0)
                         "!2!"
                         0)
                  "!0!"
                  0)))
  (store a!1 "!3!" 200000000000))|
|winner              |"!3!"               |
|secondhighestBid    |0                   |
|utilities           |(let ((a!1 (store (store (store ((as const (Array String Int)) 1) "!3!" 0)
                         "!2!"
                         0)
                  "!0!"
                  0)))
...
|highestBid          |200000000000        |
----------------Local Variable-----------------------
|winners_count       |1                   |
|msg_price3          |200000000000        |
...
-------------------------------------------------------------------------
|utilities[msg_sender3]        |200000000000                            |
-------------------------------------------------------------------------
|revenue                       |value                                   |
-------------------------------------------------------------------------
...
*         report                    *
*************************************
* model construction time: 5.874s
*  property checking time: 0.071s
*              total time: 5.945s
