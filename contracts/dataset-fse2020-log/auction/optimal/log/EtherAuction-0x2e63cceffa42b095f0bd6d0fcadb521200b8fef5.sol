...
local variables: 
	varName: winners_count@834, value: winners_count@834_0_, sort: Int
...
----------------State Variable-----------------------
|name                |value               |
|payments            |(let ((a!1 (store (store (store ((as const (Array String Int)) 5) "!2!" 0)
                         "!3!"
                         0)
                  "!0!"
                  0)))
  (store a!1 "!3!" 120000000000))|
|benefits            |(let ((a!1 (store (store (store ((as const (Array String Int)) 4) "!2!" 0)
                         "!3!"
                         0)
                  "!0!"
                  0)))
...
|auctionStarted      |true                |
|latestBidTime       |1                   |
|utilities           |(let ((a!1 (store (store (store ((as const (Array String Int)) 3) "!2!" 0)
                         "!3!"
                         0)
                  "!0!"
                  0)))
  (store a!1 "!3!" (- 19999999999)))|
|highestBid          |240000000000        |
|secondHighestBid    |120000000000        |
|secondHighestBidder |"!2!"               |
|highestBidder       |"!3!"               |
|auctionEndTime      |7200                |
|balances            |(let ((a!1 (store (store (store ((as const (Array String Int)) 2) "!2!" 0)
                         "!3!"
                         0)
                  "!0!"
                  0)))
  (store (store a!1 "!2!" 120000000000) "!3!" 240000000000))|
----------------Local Variable-----------------------
|winners_count       |1                   |
|msg_value3          |240000000000        |
|p2                  |100000000001        |
|msg_value1          |120000000001        |
|p1                  |100000000001        |
|msg_sender1         |"!0!"               |
|_newBid             |240000000000        |
|previousBid         |0                   |
|_newBidder          |"!3!"               |
|msg_sender2         |"!2!"               |
|block_timestamp     |1                   |
...
|msg_sender          |"!3!"               |
|p3                  |100000000001        |
|msg_value2          |120000000000        |
|msg_value           |240000000000        |
|block_timestamp3    |1                   |
|block_timestamp2    |(- 1)               |
|block_timestamp1    |(- 1)               |
-------------------------------------------
...
-------------------------------------------------------------------------
|utilities[msg_sender3]        |(- 19999999999)                         |
-------------------------------------------------------------------------
|revenue                       |value                                   |
-------------------------------------------------------------------------
...
hint
payment:120000000000
optional payment:120000000001
**************************************
*    outcome pattern                 *
**************************************
*************************************
*         report                    *
*************************************
* model construction time: 8.531s
*  property checking time: 0.08s
*              total time: 8.611s
