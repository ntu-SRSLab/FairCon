...
local variables: 
	varName: winners_count@1223, value: winners_count@1223_0_, sort: Int
...
----------------State Variable-----------------------
|name                |value               |
|payments            |(store (store (store ((as const (Array String Int)) 4) "!0!" 0) "!2!" 0)
       "!3!"
       120000000000)|
|utilities           |(store (store (store ((as const (Array String Int)) 2) "!0!" 0) "!2!" 0)
       "!3!"
       (- 19999999999))|
|fundsByBidder       |(let ((a!1 (store (store (store ((as const (Array String Int)) 1) "!0!" 0)
                         "!2!"
                         0)
                  "!3!"
                  0)))
  (store a!1 "!1!" 120000000001))|
|blockerPay          |false               |
|highestBidder       |"!3!"               |
|oldHighestBindingBid|0                   |
|oldPotato           |120000000000        |
|benefits            |(store (store (store ((as const (Array String Int)) 3) "!0!" 0) "!2!" 0)
       "!3!"
       100000000001)|
...
*         report                    *
*************************************
* model construction time: 2.43s
*  property checking time: 0.074s
*              total time: 2.504s
