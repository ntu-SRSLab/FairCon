...
local variables: 
	varName: winners_count@790, value: winners_count@790_0_, sort: Int
...
----------------State Variable-----------------------
|name                |value               |
|payments            |(store (store (store ((as const (Array String Int)) 6) "!3!" 0) "!2!" 0)
       "!0!"
       100000000001)|
|startingPrice       |0                   |
|currentBid          |100000000001        |
|totalBids           |1                   |
|auctionEnd          |0                   |
|hotPotatoPrize      |5000000000          |
|currentMinBid       |150000000001        |
|balanceOf           |(store (store (store ((as const (Array String Int)) 3) "!3!" 0) "!2!" 0)
       "!0!"
       105000000001)|
|highBidder          |"!0!"               |
|utilities           |(store (store (store ((as const (Array String Int)) 4) "!3!" 0) "!2!" 0)
       "!0!"
       0)|
|benefits            |(store (store (store ((as const (Array String Int)) 5) "!3!" 0) "!2!" 0)
       "!0!"
       100000000001)|
----------------Local Variable-----------------------
|winners_count       |1                   |
...
hint
payment:100000000001
optional payment:100000000002
**************************************
*    outcome pattern                 *
**************************************
*************************************
*         report                    *
*************************************
* model construction time: 5.479s
