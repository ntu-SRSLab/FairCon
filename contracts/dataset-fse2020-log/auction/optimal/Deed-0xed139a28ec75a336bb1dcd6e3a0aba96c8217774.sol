  ...
  function sse_optimal_violate_check(uint benefit, address allocation, address other_allocation) public view {}
   ...
   address payable msg_sender3, uint p3, uint msg_value3, uint msg_price3, uint block_timestamp3) public {
           ...
           // each role claims the 'bid' action.
            ...
            sse_optimal_payment_register(winner, msg_sender1, msg_value1);
            sse_optimal_payment_register(winner, msg_sender2, msg_value2);
            sse_optimal_payment_register(winner, msg_sender3, msg_value3);
            sse_optimal_violate_check(payments[msg_sender1]+payments[msg_sender2]+payments[msg_sender3],winner,msg_sender1);
