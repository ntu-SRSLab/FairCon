          ...
          // require(msg_value4==p4);
           ...
           // each role claims the 'bid' action.
            ...
            sse_utility(utilities[msg_sender4]);
             ...
             sse_optimal_violate_check(payments[msg_sender1]+payments[msg_sender2]+payments[msg_sender3]+payments[msg_sender4],highestBidder,msg_sender1);
             sse_optimal_violate_check(payments[msg_sender1]+payments[msg_sender2]+payments[msg_sender3]+payments[msg_sender4],highestBidder,msg_sender2);
             sse_optimal_violate_check(payments[msg_sender1]+payments[msg_sender2]+payments[msg_sender3]+payments[msg_sender4],highestBidder,msg_sender3);
             sse_optimal_violate_check(payments[msg_sender1]+payments[msg_sender2]+payments[msg_sender3]+payments[msg_sender4],highestBidder,msg_sender4);
      }
}
