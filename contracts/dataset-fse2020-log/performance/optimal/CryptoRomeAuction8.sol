...
contract CryptoRomeAuction {
   ...
   function _Main_(address payable msg_sender1, uint p1, uint msg_value1, uint msg_gas1, uint block_timestamp1, address payable msg_sender2, uint p2, uint msg_value2, uint msg_gas2, uint block_timestamp2,address payable msg_sender3, uint p3, uint msg_value3, uint msg_gas3, uint block_timestamp3, address payable msg_sender4, uint p4, uint msg_value4, uint msg_gas4, uint block_timestamp4, address payable msg_sender5, uint p5, uint msg_value5, uint msg_gas5, uint block_timestamp5,address payable msg_sender6,uint p6, uint msg_value6, uint msg_gas6, uint block_timestamp6,address payable msg_sender7,uint p7, uint msg_value7, uint msg_gas7, uint block_timestamp7,address payable msg_sender8,uint p8, uint msg_value8, uint msg_gas8, uint block_timestamp8) public {
           require(!(msg_sender1==highestBidder || msg_sender2 == highestBidder || msg_sender3 == highestBidder|| msg_sender4 == highestBidder|| msg_sender5 == highestBidder|| msg_sender6 == highestBidder|| msg_sender7 == highestBidder|| msg_sender8 == highestBidder));
           ...
           // each role claims the 'bid' action.
            ...
            assert(msg_sender1 == highestBidder || msg_sender2 == highestBidder ||  msg_sender3 == highestBidder|| msg_sender4 == highestBidder || msg_sender5 == highestBidder || msg_sender6 == highestBidder|| msg_sender7 == highestBidder|| msg_sender8 == highestBidder);
            ...
            sse_utility(utilities[msg_sender8]);
             uint revenue = payments[msg_sender1]+ payments[msg_sender2]+payments[msg_sender3]+payments[msg_sender4]+payments[msg_sender5]+payments[msg_sender6]+payments[msg_sender7]+payments[msg_sender8]; 
