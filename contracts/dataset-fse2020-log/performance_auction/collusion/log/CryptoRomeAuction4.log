...
local variables: 
	...
	varName: winners_count@570, value: winners_count@570_0_, sort: Int
...
|benefits            |(let ((a!1 (store (store (store ((as const (Array String Int)) 4) "!3!" 0)
                  ...
                  "!0!"
                  0)))
  (store (store a!1 "!2!" 0) "!0!" 100000000002))|
|extensionTime       |2                   |
|utilities           |(let ((a!1 (store (store (store ((as const (Array String Int)) 3) "!3!" 0)
                  ...
                  "!0!"
                  0)))
  (store (store a!1 "!2!" 0) "!0!" 0))|
|auctionStart        |0                   |
|payments            |(let ((a!1 (store (store (store ((as const (Array String Int)) 5) "!3!" 0)
                         "!4!"
                         0)
                  "!0!"
                  0)))
...
*         report                    *
*************************************
* model construction time: 29.472s
*  property checking time: 0.104s
*              total time: 29.576s
