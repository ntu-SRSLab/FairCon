...
local variables: 
	varName: winners_count@665, value: winners_count@665_0_, sort: Int
...
----------------State Variable-----------------------
|name                |value               |
|benefits            |(let ((a!1 (store (store (store ((as const (Array String Int)) 5) "!5!" 0)
                         "!3!"
                         0)
                  "!4!"
                  0)))
  (store (store (store a!1 "!0!" 0) "!2!" 0) "!0!" 100000000003))|
|extensionTime       |2                   |
|utilities           |(let ((a!1 (store (store (store ((as const (Array String Int)) 4) "!5!" 0)
                         "!3!"
                         0)
                  "!4!"
                  0)))
  (store (store (store a!1 "!0!" 0) "!2!" 0) "!0!" 0))|
|auctionStart        |0                   |
|payments            |(let ((a!1 (store (store (store ((as const (Array String Int)) 6) "!5!" 0)
                         "!3!"
                         0)
                  "!4!"
                  0)))
  (store (store a!1 "!0!" 0) "!2!" 0))|
|auctionEnd          |2                   |
|highestBid          |100000000003        |
|highestBidder       |"!0!"               |
|highestBidderCC     |""                  |
...
|block_timestamp5    |0                   |
|msg_gas             |msg_gas5@276_0_     |
|block_timestamp     |0                   |
|msg_value1          |100000000003        |
|msg_value4          |100000000001        |
|msg_value3          |100000000001        |
|msg_value2          |110000000002        |
|msg_sender1         |"!0!"               |
|p1                  |100000000003        |
|msg_sender2         |"!2!"               |
-------------------------------------------
...
hint
msg_value1@234_0_:100000000003
msg_value2@244_0_:110000000002
...
*         report                    *
*************************************
* model construction time: 105.891s
*  property checking time: 0.133s
*              total time: 106.024s
*  pattern [ fairness:(contexts)-(violates) ] 
*      truthful:162-0
*collusion-free:162-1
*       optimal:162-0
*     efficient:162-0
*************************************
