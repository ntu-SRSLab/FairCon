...
local variables: 
	varName: winners_count@647, value: winners_count@647_0_, sort: Int
	...
	varName: expectation@811, value: expectation@811_0_, sort: Int
...
----------------State Variable-----------------------
|name                |value               |
|benefits            |(let ((a!1 (store (store (store ((as const (Array String Int)) 4) "!5!" 0)
                         "!3!"
                         0)
                  "!4!"
                  0)))
  (store (store (store a!1 "!0!" 0) "!2!" 0) "!0!" 100000000001))|
|extensionTime       |2                   |
|utilities           |(let ((a!1 (store (store (store ((as const (Array String Int)) 3) "!5!" 0)
                         "!3!"
                         0)
                  "!4!"
                  0)))
...
|auctionStart        |0                   |
|payments            |(let ((a!1 (store (store (store ((as const (Array String Int)) 5) "!5!" 0)
                         "!3!"
                         0)
                  "!4!"
                  0)))
...
*         report                    *
*************************************
* model construction time: 107.064s
*  property checking time: 0.116s
*              total time: 107.18s
*  pattern [ fairness:(contexts)-(violates) ] 
*      truthful:162-0
*collusion-free:162-0
*       optimal:162-0
*     efficient:162-1
*************************************
