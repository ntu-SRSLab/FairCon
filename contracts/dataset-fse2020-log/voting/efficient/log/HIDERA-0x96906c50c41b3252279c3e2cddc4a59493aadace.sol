...
local variables: 
	...
	varName: g_false@470, value: g_false@470_0_, sort: Int
...
|utilities           |(let ((a!1 (store (store (store ((as const (Array String Int)) 8) "!4!" 0)
                  ...
                  "!0!"
                  0)))
(let ((a!2 (store (store (store (store a!1 "!3!" 0) "!1!" 0) "!4!" 976)
                  "!3!"
                  18097)))
  (store (store (store a!2 "!2!" 6285) "!0!" 2) "!1!" 8947)))|
|proposals           |2                   |
...
|utilities                     |value                                   |
-------------------------------------------------------------------------
|utilities[msg_sender1]        |976                                     |
-------------------------------------------------------------------------
|utilities[msg_sender2]        |18097                                   |
-------------------------------------------------------------------------
|utilities[msg_sender3]        |6285                                    |
-------------------------------------------------------------------------
|utilities[msg_sender4]        |2                                       |
-------------------------------------------------------------------------
|utilities[msg_sender5]        |8947                                    |
-------------------------------------------------------------------------
|revenue                       |value                                   |
-------------------------------------------------------------------------
...
*         report                    *
*************************************
* model construction time: 155.845s
*  property checking time: 0.497s
*              total time: 156.342s
