...
local variables: 
	...
	varName: g_false@663, value: g_false@663_0_, sort: Int
...
----------------State Variable-----------------------
|name                |value               |
|utilities           |(let ((a!1 (store (store (store ((as const (Array String Int)) 21) "\x00" 0)
                         "\x08"
                         0)
                  "\x00\x00"
                  0)))
(let ((a!2 (store (store (store (store a!1 "" 0) "\x80" 0) "" 23810)
                  "\x80"
                  8947)))
  (store (store (store a!2 "\x08" 8100) "\x00" 5922) "\x00\x00" 842)))|
|proposals           |2                   |
...
|voters              |(let ((a!1 (store (store ((as const (Array String Voter)) (Voter 9 false "" 2))
                  ...
                  "\x08"
                  (Voter 1 false "" 5))))
(let ((a!2 (store (store (store a!1 "\x00\x00" (Voter 1 false "" 7))
                         ""
                         (Voter 1 false "" 8))
                  "\x80"
                  (Voter 1 false "" 6))))
(let ((a!3 (store (store (store a!2 "" (Voter 1 true "" 0))
                  ...
                  "\x08"
                  (Voter 1 true "" 0))))
  (store (store a!3 "\x00" (Voter 1 true "" 0)) "\x00\x00" (Voter 1 true "" 0)))))|
----------------Local Variable-----------------------
|msg_value5          |true                |
|p5_rv_value         |841                 |
|p5_value            |842                 |
...
|utilities                     |value                                   |
-------------------------------------------------------------------------
|utilities[msg_sender1]        |23810                                   |
-------------------------------------------------------------------------
|utilities[msg_sender2]        |8947                                    |
-------------------------------------------------------------------------
|utilities[msg_sender3]        |8100                                    |
-------------------------------------------------------------------------
|utilities[msg_sender4]        |5922                                    |
-------------------------------------------------------------------------
|utilities[msg_sender5]        |842                                     |
-------------------------------------------------------------------------
|revenue                       |value                                   |
-------------------------------------------------------------------------
...
*         report                    *
*************************************
* model construction time: 371.383s
*  property checking time: 1.247s
*              total time: 372.63s
