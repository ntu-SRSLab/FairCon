...
|utilities           |(let ((a!1 (store (store (store ((as const (Array String Int)) 8) "!4!" 0)
                  ...
                  "!0!"
                  0)))
(let ((a!2 (store (store (store (store a!1 "!3!" 0) "!1!" 0) "!4!" 17222)
                  "!3!"
                  2)))
  (store (store (store a!2 "!2!" 2439) "!0!" 1798) "!1!" 1238)))|
|proposals           |2                   |
...
|utilities                     |value                                   |
-------------------------------------------------------------------------
|utilities[msg_sender1]        |17222                                   |
-------------------------------------------------------------------------
|utilities[msg_sender2]        |2                                       |
-------------------------------------------------------------------------
|utilities[msg_sender3]        |2439                                    |
-------------------------------------------------------------------------
|utilities[msg_sender4]        |1798                                    |
-------------------------------------------------------------------------
...
hint
msg_value1@201_0_:false
msg_value2@211_0_:true
msg_value1@201_0_#2:true
msg_value2@211_0_#2:false
v1&v2's utility:17222
...
*         report                    *
*************************************
* model construction time: 49.94s
*  property checking time: 0.114s
*              total time: 50.054s
