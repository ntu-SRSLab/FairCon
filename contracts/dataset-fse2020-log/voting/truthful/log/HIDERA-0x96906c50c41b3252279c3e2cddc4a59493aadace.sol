...
local variables: 
	...
	varName: v_2@157, value: v_2@157_0_, sort: Int
	...
	varName: v2@155, value: v2@155_0_, sort: Int
	...
	varName: v1@151, value: v1@151_0_, sort: Int
	...
	varName: v_1@153, value: v_1@153_0_, sort: Int
	varName: winner@351, value: winner@351_0_, sort: Int
...
----------------State Variable-----------------------
|name                |value               |
|utilities           |(let ((a!1 (store (store (store ((as const (Array String Int)) 8) "!4!" 0)
                         "!2!"
                         0)
                  "!0!"
                  0)))
(let ((a!2 (store (store (store (store a!1 "!3!" 0) "!1!" 0) "!4!" 8857)
                  "!3!"
                  2439)))
  (store (store (store a!2 "!2!" 2) "!0!" 7721) "!1!" 1238)))|
|proposals           |2                   |
...
|utilities                     |value                                   |
-------------------------------------------------------------------------
|utilities[msg_sender1]        |8857                                    |
-------------------------------------------------------------------------
|utilities[msg_sender2]        |2439                                    |
-------------------------------------------------------------------------
|utilities[msg_sender3]        |2                                       |
-------------------------------------------------------------------------
|utilities[msg_sender4]        |7721                                    |
-------------------------------------------------------------------------
|utilities[msg_sender5]        |1238                                    |
-------------------------------------------------------------------------
|revenue                       |value                                   |
-------------------------------------------------------------------------
...
hint
msg_value1@201_0_: true
msg_value1@201_0_#2: false
a's utility::0
new a's utility:1
-------------------------------------------------------------------------
...
*         report                    *
*************************************
* model construction time: 40.146s
