...
contract Rewrite{
    ...
    function newProposal(uint numberOfProposal) public {
        proposals.length = numberOfProposal;
        voteCount[0] = 0;
        voteCount[1] = 0;
    }

    function vote(uint256 proposalNum) public returns (bool success){
        voteCount[proposalNum] = voteCount[proposalNum]+1;
        return true;
    }
    
    function getWinner() public returns (int winnerName){
