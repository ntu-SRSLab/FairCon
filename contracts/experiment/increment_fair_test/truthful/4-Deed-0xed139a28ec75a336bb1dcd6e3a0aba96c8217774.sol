...
contract Rewrite{
  ...
  function sse_validate_outcome_postcondition(string memory desc, bool condition) public view {}
   ...
   address payable msg_sender4, uint p4, uint msg_value4, uint msg_price4, uint block_timestamp4) public {
           ...
           // each role claims the 'bid' action.
            ...
            assert(msg_sender1 == winner || msg_sender2 == winner ||  msg_sender3 == winner||  msg_sender4 == winner );
