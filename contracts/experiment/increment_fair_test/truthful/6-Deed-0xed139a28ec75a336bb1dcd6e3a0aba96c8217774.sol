...
contract Rewrite{
  ...
  function bid(address msg_sender, uint msg_value, uint msg_price) public payable{
        uint value = msg_price;
        if (msg_value<=msg_price) value = msg_value;
        if (value < minPrice ) {
            // Bid too low or too late, refund 99.5%
            return;
        } else if (value > highestBid) {
            secondhighestBid = highestBid;  // will be zero if there's only 1 bidder
            highestBid = value;
            winner = msg_sender;
  ...
  function sse_validate_outcome_postcondition(string memory desc, bool condition) public view {}
   ...
   address payable msg_sender3, uint p3, uint msg_value3, uint msg_price3, uint block_timestamp3,
   address payable msg_sender4, uint p4, uint msg_value4, uint msg_price4, uint block_timestamp4,
   address payable msg_sender5, uint p5, uint msg_value5, uint msg_price5, uint block_timestamp5,
   address payable msg_sender6, uint p6, uint msg_value6, uint msg_price6, uint block_timestamp6
		  ) public {
           ...
           require(!(msg_sender5==msg_sender1 || msg_sender5 == msg_sender2 || msg_sender5 == msg_sender3));
	   require(!(msg_sender5==msg_sender4));
           require(!(msg_sender6==msg_sender1 || msg_sender6 == msg_sender2 || msg_sender6 == msg_sender3));
	   require(!(msg_sender6==msg_sender4));
	   require(!(msg_sender6==msg_sender5));
           require(highestBid==0);
           require(secondhighestBid==0);
           require(minPrice==100000000000);
           ...
           require(p5>100000000000 && p5< 900000000000);
           require(p6>100000000000 && p6< 900000000000);
           ...
           require(msg_value5>100000000000 && msg_value5< 900000000000);
           require(msg_value6>100000000000 && msg_value6< 900000000000);
           ...
           require(msg_price4>100000000000 && msg_price4< 900000000000);
           require(msg_price5>100000000000 && msg_price5< 900000000000);
           require(msg_price6>100000000000 && msg_price6< 900000000000);
           ...
           require(msg_value1==msg_price1);
           require(msg_value2==msg_price2);
           require(msg_value3==msg_price3);
           require(msg_value4==msg_price4);
           require(msg_value5==msg_price5);
           require(msg_value6==msg_price6);
           // each role claims the 'bid' action.
            bid(msg_sender1,msg_value1,msg_price1);
            bid(msg_sender2,msg_value2,msg_price2);
            bid(msg_sender3,msg_value3,msg_price3);
            bid(msg_sender4,msg_value4,msg_price4);
            bid(msg_sender5,msg_value5,msg_price5);
            bid(msg_sender6,msg_value6,msg_price6);

              // assert(msg_sender3 == winner);
            assert(msg_sender1 == winner || msg_sender2 == winner ||  msg_sender3 == winner||  msg_sender4 == winner||  msg_sender5 == winner||  msg_sender6 == winner );
	    ...
	    uint secondhighest_price = 0;
            ...
            if(highest_price<msg_price1){
		    secondhighest_price = highest_price;
		    highest_price = msg_price1;
	    }else if (secondhighest_price < msg_price1){
		    secondhighest_price = msg_price1;
	    }
	   
            if(highest_price<msg_price2){
		    secondhighest_price = highest_price;
		    highest_price = msg_price2;
	    }
	    else if (secondhighest_price < msg_price2){
		    secondhighest_price = msg_price2;
	    }
            if(highest_price<msg_price3){
		    secondhighest_price = highest_price;
		    highest_price = msg_price3;
	    }
	    else if (secondhighest_price < msg_price3){
		    secondhighest_price = msg_price3;
	    }
            if(highest_price<msg_price4){
		    secondhighest_price = highest_price;
		    highest_price = msg_price4;
	    }
	    else if (secondhighest_price < msg_price4){
		    secondhighest_price = msg_price4;
  	    }
            if(highest_price<msg_price5){
		    secondhighest_price = highest_price;
		    highest_price = msg_price5;
	    }
	    else if (secondhighest_price < msg_price5){
		    secondhighest_price = msg_price5;
	    }
            if(highest_price<msg_price6){
		    secondhighest_price = highest_price;
		    highest_price = msg_price6;
	    }
	    else if (secondhighest_price < msg_price6){
		    secondhighest_price = msg_price6;
	    }
            if ( msg_sender1 == winner ){
                        sse_winner(msg_sender1);
                        winners_count ++;
			winner_value = msg_price1;
            ...
            if ( msg_sender4 == winner ){
                        sse_winner(msg_sender4);
                        winners_count ++;
			winner_value = msg_price4;
                        utilities[msg_sender3] = p4 - secondhighestBid;
                        benefits[msg_sender3]  = p4;
                        payments[msg_sender3]  = secondhighestBid;
            }
            sse_utility(utilities[msg_sender4]);
            if ( msg_sender5 == winner ){
                        sse_winner(msg_sender5);
                        winners_count ++;
			winner_value = msg_price5;
                        utilities[msg_sender3] = p5 - secondhighestBid;
                        benefits[msg_sender3]  = p5;
                        payments[msg_sender3]  = secondhighestBid;
            }
            sse_utility(utilities[msg_sender5]);
            if ( msg_sender6 == winner ){
                        sse_winner(msg_sender6);
                        winners_count ++;
			winner_value = msg_price6;
                        utilities[msg_sender3] = p6 - secondhighestBid;
                        benefits[msg_sender3]  = p6;
                        payments[msg_sender3]  = secondhighestBid;
            }
