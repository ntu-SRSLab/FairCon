...
contract CryptoRomeAuction {
   ...
   function _Main_(address payable msg_sender1, uint p1, uint msg_value1, uint msg_gas1, uint block_timestamp1, address payable msg_sender2, uint p2, uint msg_value2, uint msg_gas2, uint block_timestamp2,address payable msg_sender3, uint p3, uint msg_value3, uint msg_gas3, uint block_timestamp3, address payable msg_sender4, uint p4, uint msg_value4, uint msg_gas4, uint block_timestamp4, address payable msg_sender5, uint p5, uint msg_value5, uint msg_gas5, uint block_timestamp5,address payable msg_sender6,uint p6, uint msg_value6, uint msg_gas6, uint block_timestamp6,address payable msg_sender7,uint p7, uint msg_value7, uint msg_gas7, uint block_timestamp7,address payable msg_sender8,uint p8, uint msg_value8, uint msg_gas8, uint block_timestamp8,address payable msg_sender9,uint p9, uint msg_value9, uint msg_gas9, uint block_timestamp9) public {
           require(!(msg_sender1==highestBidder || msg_sender2 == highestBidder || msg_sender3 == highestBidder|| msg_sender4 == highestBidder|| msg_sender5 == highestBidder|| msg_sender6 == highestBidder|| msg_sender7 == highestBidder|| msg_sender8 == highestBidder|| msg_sender9 == highestBidder));
           ...
           require(!(msg_sender8==msg_sender1 || msg_sender8 == msg_sender2 || msg_sender8 == msg_sender3||msg_sender8 == msg_sender4||msg_sender8 == msg_sender5||msg_sender8 == msg_sender6||msg_sender8 == msg_sender7));
           require(!(msg_sender9==msg_sender1 || msg_sender9 == msg_sender2 || msg_sender9 == msg_sender3||msg_sender9 == msg_sender4||msg_sender9 == msg_sender5||msg_sender9 == msg_sender6||msg_sender9 == msg_sender7||msg_sender9 == msg_sender8));
           ...
           require(p8>100000000000 && p8< 200000000000);
           require(p9>100000000000 && p9< 200000000000);
           ...
           require(msg_value8>100000000000 && msg_value8< 200000000000);
           require(msg_value9>100000000000 && msg_value9< 200000000000);
           ...
           require(utilities[msg_sender8] == 0);
           require(utilities[msg_sender9] == 0);
           ...
           require(benefits[msg_sender8] == 0);
           require(benefits[msg_sender9] == 0);
           ...
           require(payments[msg_sender8] == 0);
           require(payments[msg_sender9] == 0);
           ...
           //require(msg_value8==p8);
           //require(msg_value9==p9);
           ...
           // each role claims the 'bid' action.
            ...
            bid(msg_sender8,msg_value8,msg_gas8,block_timestamp8);
            bid(msg_sender9,msg_value9,msg_gas9,block_timestamp9);

            assert(msg_sender1 == highestBidder || msg_sender2 == highestBidder ||  msg_sender3 == highestBidder|| msg_sender4 == highestBidder || msg_sender5 == highestBidder || msg_sender6 == highestBidder|| msg_sender7 == highestBidder|| msg_sender8 == highestBidder|| msg_sender9 == highestBidder);
            ...
            if ( msg_sender8 == highestBidder ){
                        sse_winner(msg_sender8);
                        winners_count ++;
                        utilities[msg_sender8] = p8 - msg_value8;
                        benefits[msg_sender8]  = p8;
            }
            sse_utility(utilities[msg_sender8]);
            if ( msg_sender9 == highestBidder ){
                        sse_winner(msg_sender9);
                        winners_count ++;
                        utilities[msg_sender9] = p9 - msg_value9;
                        benefits[msg_sender9]  = p9;
            }
            sse_utility(utilities[msg_sender9]);
             uint revenue = payments[msg_sender1]+ payments[msg_sender2]+payments[msg_sender3]+payments[msg_sender4]+payments[msg_sender5]+payments[msg_sender6]+payments[msg_sender7]+payments[msg_sender8]+payments[msg_sender9]; 
             ...
             sse_optimal_payment_register(highestBidder, msg_sender4, msg_value4);
             sse_optimal_payment_register(highestBidder, msg_sender5, msg_value5);
             sse_optimal_payment_register(highestBidder, msg_sender6, msg_value6);
             sse_optimal_payment_register(highestBidder, msg_sender7, msg_value7);
             sse_optimal_payment_register(highestBidder, msg_sender8, msg_value8);
             sse_optimal_payment_register(highestBidder, msg_sender9, msg_value9);
             sse_optimal_violate_check(revenue,highestBidder,msg_sender1);
             sse_optimal_violate_check(revenue,highestBidder,msg_sender2);
             sse_optimal_violate_check(revenue,highestBidder,msg_sender3);
             sse_optimal_violate_check(revenue,highestBidder,msg_sender4);
             sse_optimal_violate_check(revenue,highestBidder,msg_sender5);
             sse_optimal_violate_check(revenue,highestBidder,msg_sender6);
             sse_optimal_violate_check(revenue,highestBidder,msg_sender7);
             sse_optimal_violate_check(revenue,highestBidder,msg_sender8);
             sse_optimal_violate_check(revenue,highestBidder,msg_sender9);
      }
}
