...
class CFGConstVisitor
{
public:
	virtual ~CFGConstVisitor() = default;
	virtual bool visit(FunctionDefinition const& _function) { return visitNode(_function); }
...
public:
  ...
  void accept(CFGConstVisitor& _visitor) const;
