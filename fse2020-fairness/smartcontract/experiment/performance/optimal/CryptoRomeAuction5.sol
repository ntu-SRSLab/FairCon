         ...
         //  require(msg_value5==p5);
           ...
           // each role claims the 'bid' action.
            ...
            sse_utility(utilities[msg_sender5]);
             uint revenue = payments[msg_sender1]+ payments[msg_sender2]+payments[msg_sender3]+payments[msg_sender4]+payments[msg_sender5]; 
