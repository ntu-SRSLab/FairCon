...
contract CryptoRomeAuction {
   ...
   function _Main_(address payable msg_sender1, uint p1, uint msg_value1, uint msg_gas1, uint block_timestamp1, address payable msg_sender2, uint p2, uint msg_value2, uint msg_gas2, uint block_timestamp2,address payable msg_sender3, uint p3, uint msg_value3, uint msg_gas3, uint block_timestamp3, address payable msg_sender4, uint p4, uint msg_value4, uint msg_gas4, uint block_timestamp4, address payable msg_sender5, uint p5, uint msg_value5, uint msg_gas5, uint block_timestamp5,address payable msg_sender6,uint p6, uint msg_value6, uint msg_gas6, uint block_timestamp6) public {
           require(!(msg_sender1==highestBidder || msg_sender2 == highestBidder || msg_sender3 == highestBidder|| msg_sender4 == highestBidder|| msg_sender5 == highestBidder|| msg_sender6 == highestBidder));
        ...
        //  require(msg_value4==p4);
         ...
         //  require(msg_value6==p6);
           ...
           // each role claims the 'bid' action.
            ...
            assert(msg_sender1 == highestBidder || msg_sender2 == highestBidder ||  msg_sender3 == highestBidder|| msg_sender4 == highestBidder || msg_sender5 == highestBidder || msg_sender6 == highestBidder);
            ...
            sse_utility(utilities[msg_sender6]);
             uint revenue = payments[msg_sender1]+ payments[msg_sender2]+payments[msg_sender3]+payments[msg_sender4]+payments[msg_sender5]+payments[msg_sender6]; 
